...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(e) {
	  ...
	  var objSignUp = getFormFields(e.target);
	...
	var onSignIn = function onSignIn(e) {
	  e.preventDefault();
	  var objSignIn = getFormFields(e.target);
	  api.signIn(objSignIn).then(ui.signInSuccess).catch(ui.signInFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(5);
	var objPlayer = __webpack_require__(6);

	// Invokes sign-up API
	var signUp = function signUp(objSignUp) {
	  ...
	  objPlayer.fnIsLoggedIn(null, objSignUp.credentials.email, objSignUp.credentials.password);
	...
	var signIn = function signIn(objSignIn) {
	  ...
	  objPlayer.fnIsLoggedIn(null, objSignIn.credentials.email, objSignIn.credentials.password);
...
/***/ (function(module, exports) {
	...
	var Player = function Player(bool, strName, strId, strAuthNToken) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var objGameEvents = __webpack_require__(10);
	var objPlayer = __webpack_require__(6);

	var signInSuccess = function signInSuccess(objResponse) {
	  ...
	  objPlayer.fnIsLoggedIn(true, objResponse.user.email, objResponse.user.id, objResponse.user.token);
	...
	var signInFailure = function signInFailure(objResponse) {
	...
	var signUpSuccess = function signUpSuccess(objResponse) {
	  ...
	  $('.announcements').html('Welcome, ' + objResponse.user.email + '. Please log in or register another user.');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AllPaths = __webpack_require__(12);
	...
	Game.prototype.addMove = function (intSquareIndex) {
	  ...
	  if (this._arrSquareStates[intSquareIndex] !== '') {
	    ...
	    $('.announcements').html('Sorry ' + this._strTurn + ', you cannnot change an occupied square. Click an empty square .');
	    return false;
	  }
	  ...
	  var objAllPaths = new AllPaths(this._arrSquareStates);
